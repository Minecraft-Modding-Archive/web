        ...
        <div className={styles.aboutContainer}>
          <div className={styles.aboutCard}>
            <div className={styles.rowCentered}>
              ...
              <Image className={styles.aboutCardImage} alt="" src="/voidxwalker.png" width={110} height={110} />
            </div>
          ...
          <div className={styles.aboutCard}>
            <div className={styles.rowCentered}>
              ...
              <Image className={styles.aboutCardImage} alt="" src="/kaishibi.png" width={110} height={110} />
            </div>
